...
//! preprocessing validation, enabling quality gates for downstream processing
//! and ML processing.
//!
//! # Metrics
//!
...
//! println!("SNR: {:.1} dB, Quality: {:.2}", metrics.snr_db, metrics.quality_score);
//! # Ok(())
//! # }
//! ```
...
///
/// All metrics are computed for a single audio chunk and provide
/// objective measures of audio quality for downstream processing decisions.
